...
export default function BookAppointment({open, onClose}) {
  return (
    <>
                    ...
                    <Grid  sx={{borderRadius:"15px"}} container>
                        <Grid item xs={12} sx={{backgroundColor:"#EEF0FA" , borderRadius:"10px"}}>
                            <Box sx={{padding:"20px 30px"}}>
                                <Typography sx={{fontSize:"18px", fontWeight:"600", color:"#243665"}}>Book an Appointment</Typography>
                            </Box>
                        </Grid>
                        <hr/>
                        ...
                        <Box component="form" noValidate>
                            <Grid container spacing={2} >
                                ...
                                <FormControl>
                                    <Box display={'flex'}>
                                        <Box sx={{mt:"10px"}}> <FormLabel sx={{color:"#000000"}} lab id="demo-radio-buttons-group-label">Gender</FormLabel> </Box>
